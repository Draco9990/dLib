...
public class UITextureResourcePicker extends UIResourcePicker{
    @Override
    ...
    public static class TextureResourcePickerWindowResource extends ResourcePickerWindow.ResourcePickerWindowResource {
