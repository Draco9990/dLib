...
public class PropertyEditor extends UIElement {
    ...
    public PropertyEditor(AbstractPosition xPos, AbstractPosition yPos, AbstractDimension width, AbstractDimension height) {
        ...
        VerticalBox elementList = new VerticalBox(Pos.perc(0), Pos.perc(0), Dim.fill(), Dim.fill(), true);
        {
            propertyList = new VerticalBox(Pos.perc(0), Pos.perc(0), Dim.fill(), Dim.perc(0.8));
            elementList.addItem(propertyList);
    ...
    public static class PropertyGroup extends UIElement{
        ...
        public PropertyGroup(String categoryName) {
            ...
            VerticalBox elementBox = new VerticalBox(Pos.perc(0), Pos.perc(0), Dim.fill(), Dim.fill(), true);
            {
                titleBox = new TextBox(categoryName, Pos.px(0), Pos.px(0), Dim.fill(), Dim.px(30));
                elementBox.addItem(titleBox);

                propertyList = new VerticalListBox<TProperty<?, ?>>(Pos.px(0), Pos.px(0), Dim.fill(), Dim.auto(), true){
                    @Override
