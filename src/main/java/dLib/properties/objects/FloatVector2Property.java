...
public class FloatVector2Property extends Property<Vector2> implements Serializable {
    ...
    public FloatVector2Property setXValue(float value){
    ...
    public FloatVector2Property addOnXValueChangedListener(BiConsumer<Float, Float> listener){
        if(onXValueChangedListeners == null) onXValueChangedListeners = new ArrayList<>();
        onXValueChangedListeners.add(listener);
        return this;
    }

    public FloatVector2Property setYValue(float value){
        Vector2 currentValue = getValue();
    ...
    public FloatVector2Property addOnYValueChangedListener(BiConsumer<Float, Float> listener){
        if(onYValueChangedListeners == null) onYValueChangedListeners = new ArrayList<>();
    ...
    public FloatVector2Property setXValueName(String name){
    ...
    public FloatVector2Property setYValueName(String name){
    ...
    public FloatVector2Property setValueNames(String xName, String yName){
        this.xValName = xName;
        this.yValName = yName;
        return this;
    }
    ...
    public FloatVector2Property setMinimumX(float minimumX){
    ...
    public FloatVector2Property setMaximumX(float maximumX){
    ...
    public FloatVector2Property setMinimumY(float minimumY){
    ...
    public FloatVector2Property setMaximumY(float maximumY){
    ...
    @Override
    public FloatVector2Property setName(String newTitle) {
        return (FloatVector2Property) super.setName(newTitle);
    }
