...
public class FloatValueEditor extends AbstractValueEditor<Float> {
    ...
    public FloatValueEditor(Float value, AbstractDimension width, AbstractDimension height) {
...

        {
            ...
            inputbox.addOnValueChangedListener(s -> setValueEvent.invoke(objectConsumer -> objectConsumer.accept(Float.parseFloat(s)))); //TODO get property and set value from string
